...
export class AppComponent {
  ...
  this.apiURL = 'https://api-todoapp-2z3u.onrender.com'
  this.READ_tarefas();
  }
  ...
  REMOVER_tarefa(descricao : string){
    const index = this.arrayDeTarefas.findIndex(tarefa => tarefa.descricao === descricao) ;
    var id = this.arrayDeTarefas[index]._id;
